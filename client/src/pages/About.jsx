  ...
  return (
    <div className=" min-h-screen flex items-center justify-center p-10">
      <div className="bg-white p-8 rounded-lg shadow-md max-w-3xl w-full">
        ...
        <p className="mb-4">
          Our mission is to revolutionize the real estate experience by leveraging cutting-edge technology and industry expertise. We aim to provide a user-friendly platform that simplifies the process of buying, selling, and renting properties. We believe in transparency, integrity, and customer satisfaction, and we are committed to upholding these values in every transaction.
        </p>
