...
const CreateListing = () => {
    ...
    const getDownloadUrl = async (fileKey) => {
        const response = await fetch(`http://ec2-3-79-18-231.eu-central-1.compute.amazonaws.com:3000/api/images/Url/${fileKey}`)
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setLoading(true);
            setError(false);
            const res = await fetch("http://ec2-3-79-18-231.eu-central-1.compute.amazonaws.com:3000/api/listing/create", {
                method: "POST",
                headers: {
