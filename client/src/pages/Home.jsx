...
export default function Home() {
  ...
  useEffect(() => {
    const fetchOfferListings = async () => {
      try {
        const res = await fetch('http://ec2-3-79-18-231.eu-central-1.compute.amazonaws.com:3000/api/listing/get?offer=true&limit=4');
    ...
    const fetchRentListings = async () => {
      try {
        const res = await fetch('http://ec2-3-79-18-231.eu-central-1.compute.amazonaws.com:3000/api/listing/get?type=rent&limit=4');
        const data = await res.json();
        const listingsWithImages = await getListingsWithImages(data);
    ...
    const fetchSaleListings = async () => {
      try {
        const res = await fetch('http://ec2-3-79-18-231.eu-central-1.compute.amazonaws.com:3000/api/listing/get?type=sale&limit=4');
        const data = await res.json();
        const listingsWithImages = await getListingsWithImages(data);
