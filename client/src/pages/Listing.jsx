...
const Listing = () => {
    ...
    useEffect(() => {
        const fetchListing= async () => {
            try {
                setLoading(true)
                const response = await fetch(`http://3.124.217.171:3000/api/listing/get/${params.listingId}`);
    ...
    <main>
        ...
        {listing && !loading && !error && 
            <>
                ...
                <div className="fixed top-12 right-3 z-10 border rounded-full w-12 h-12 flex justify-center items-center bg-slate-100 cursor-pointer">
