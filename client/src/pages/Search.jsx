    ...
    useEffect(() => {
        ...
        const fetchListings = async () => {
            ...
            const searchQuery = urlParams.toString();
                const res = await fetch(`http://ec2-3-79-18-231.eu-central-1.compute.amazonaws.com:3000/api/listing/get?${searchQuery}`);
            ...
            <form onSubmit={handleSubmit} className=" flex flex-col gap-8">
                ...
                <div className=" flex items-center gap-2">
                    ...
                    id="sort_order" className=" border rounded-lg p-3">
                        <option value="reqularPrice_desc" >Price high to low</option>
                        <option value="reqularPrice_asc" >Price low to high</option>
