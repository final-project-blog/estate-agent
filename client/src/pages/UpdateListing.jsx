...
const CreateListing = () => {
    ...
    useEffect(() => {
        const fetchListing = async () => {
            ...
            const res = await fetch(`http://3.79.18.231:3000/api/listing/get/${listingId}`);
    ...
    const getDownloadUrl = async (fileKey) => {
        const result = await fetch(`http://3.79.18.231:3000/api/images/Url/${fileKey}`)
    ...
    const handleRemoveImage = async (index) => {
        ...
        await fetch(`http://3.79.18.231:3000/api/images/delete/${formData.imageKeys[index]}`, {
            method: 'DELETE'
        });
        setFormData({
            ...formData,
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setLoading(true);
            setError(false);
            const res = await fetch(`http://3.79.18.231:3000/api/listing/update/${params.listingId}`, {
                method: "POST",
                headers: {
