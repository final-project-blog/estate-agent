...
const CreateListing = () => {
    ...
    useEffect(() => {
        const fetchListing = async () => {
            ...
            const res = await fetch(`http://ec2-3-79-18-231.eu-central-1.compute.amazonaws.com:3000/api/listing/get/${listingId}`);
    ...
    const getDownloadUrl = async (fileKey) => {
        const result = await fetch(`http://ec2-3-79-18-231.eu-central-1.compute.amazonaws.com:3000/api/images/Url/${fileKey}`)
    ...
    const handleRemoveImage = async (index) => {
        ...
        await fetch(`http://ec2-3-79-18-231.eu-central-1.compute.amazonaws.com:3000/api/images/delete/${formData.imageKeys[index]}`, {
            method: 'DELETE'
        });
        setFormData({
            ...formData,
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setLoading(true);
            setError(false);
            const res = await fetch(`http://ec2-3-79-18-231.eu-central-1.compute.amazonaws.com:3000/api/listing/update/${params.listingId}`, {
                method: "POST",
                headers: {
        ...
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
            <div className="flex flex-col gap-4 flex-1">
                ...
                <div className="flex flex-wrap gap-6">
                    ...
                    <div className="flex items-center gap-2">
                        <input type="number" id="regularPrice" min="100" max="10000000" required
                        className="p-3 border border-gray-300 rounded-lg"
